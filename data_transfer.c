...
{
	static int cnt = 0;
	static int status_cnt = 50;
	static int senser_cnt = 200;
	static int rcdata_cnt = 200;
	static int motopwm_cnt = 200;
	static int senser2_cnt = 500;
	static int user_cnt = 1000;
	static int power_cnt = 1000;
	static int speed_cnt = 1000;
	static int location_cnt = 2000;
	...
	if((cnt % location_cnt) == (location_cnt-3))f.send_location += 1;
	if(++cnt>10000) cnt = 0;
/////////////////////////////////////////////////////////////////////////////////////
	if(f.send_check)
	{
...
/////////////////////////////////////////////////////////////////////////////////////
	...
	{
		f.send_status = 0;
		LIGHT_DT_Send_Status(Roll,Pitch,Yaw,(0.1f *baro_height),0,fly_ready);	
	}	
/////////////////////////////////////////////////////////////////////////////////////
...
/////////////////////////////////////////////////////////////////////////////////////
	...
	{
		f.send_senser2 = 0;
		LIGHT_DT_Send_Senser2(baroAlt,ultra_distance/10);
	}	
/////////////////////////////////////////////////////////////////////////////////////
...
/////////////////////////////////////////////////////////////////////////////////////	
	...
	{
		f.send_motopwm = 0;
		LIGHT_DT_Send_MotoPWM(motor[0],motor[1],motor[2],motor[3],0,0,0,0);
	}	
/////////////////////////////////////////////////////////////////////////////////////
